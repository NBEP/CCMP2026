...
The region is home to over 140 licensed freshwater and marine beaches (NBEP and URI-CI 2014). Additionally, 100,000 acres of estuarine waters are fully or conditionally approved for shellfish harvesting with 3,700 acres opened since 2017 (NBEP 2021d). Water quality improvements in the region’s estuaries and rivers have led to safer conditions for recreation (@fig-public-spaces-row), yet public health challenges remain, particularly in freshwater systems and urban areas, where excess nutrients and increasing temperatures drive toxic cyanobacteria blooms.
